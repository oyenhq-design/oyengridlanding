        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <h2 className="text-white mb-8">
              Built for operational clarity at global enterprise scale.
            </h2>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="rounded-[28px] overflow-hidden border border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.6)] bg-[#070B1D]">
              <img 
                src="/ops-overview.png" 
                alt="Operational Display Wall" 
