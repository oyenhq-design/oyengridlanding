...
export function OperationalInfrastructure() {
  return (
    <section className="py-24 md:py-32 bg-[#090D16] relative overflow-hidden border-b border-white/5">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="mb-16 md:mb-20">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-xs md:text-sm text-zinc-400 max-w-[280px] font-normal leading-relaxed"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            className="md:col-span-2 rounded-[24px] border border-white/[0.08] bg-[#111638]/40 backdrop-blur-md p-8 flex flex-col justify-between hover:border-[#D4A017]/30 hover:scale-[1.02] hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300 group overflow-hidden relative"
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-[#0C1029]/90 via-[#0C1029]/50 to-transparent pointer-events-none" />

            {/* Card content — sits above background */}
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div className="w-10 h-10 rounded-xl bg-[#D4A017]/10 border border-[#D4A017]/30 flex items-center justify-center text-[#D4A017] group-hover:bg-[#D4A017]/20 transition-colors">
                  <Layers className="w-5 h-5" />
                </div>
                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">01 / FEATURE</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-3">Program Management</h3>
              <p className="text-sm text-zinc-300 font-normal leading-relaxed max-w-[480px] mb-6">
            ...
            <div className="relative z-10 mt-8 pt-4 border-t border-white/[0.06] flex items-center justify-between text-xs font-bold uppercase tracking-wider text-[#D4A017] group-hover:text-[#B38012] transition-colors">
          ...
          <motion.div
            ...
            className="md:col-span-1 rounded-[24px] border border-white/[0.08] bg-[#111638]/40 backdrop-blur-md p-8 flex flex-col justify-between hover:border-[#D4A017]/40 hover:scale-[1.02] hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300 group overflow-hidden relative"
          >
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="w-10 h-10 rounded-xl bg-[#D4A017]/10 border border-[#D4A017]/30 flex items-center justify-center text-[#D4A017] group-hover:bg-[#D4A017]/20 transition-colors">
                ...
                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">02 / TRACKING</span>
              </div>
            ...
            <div className="relative p-4 rounded-xl border border-white/[0.04] bg-[#080b15]/60 min-h-[90px] flex items-center justify-center">
              <span className="text-[10px] text-zinc-400 tracking-widest uppercase font-semibold text-center">Analytics & Avatars Area</span>
            </div>

            <div className="mt-8 pt-4 border-t border-white/[0.06] flex items-center justify-between text-xs font-bold uppercase tracking-wider text-[#D4A017] group-hover:text-[#B38012] transition-colors">
          ...
          >
            ...
            <img
              ...
              className="absolute inset-0 w-full h-full object-cover object-center opacity-40 pointer-events-none select-none group-hover:scale-[1.03] transition-transform duration-700"
            />
          ...
          <motion.div
            ...
            className="md:col-span-1 rounded-[24px] border border-white/[0.08] bg-[#111638]/40 backdrop-blur-md p-8 flex flex-col justify-between hover:border-[#D4A017]/30 hover:scale-[1.02] hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300 group overflow-hidden relative"
          >
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="w-10 h-10 rounded-xl bg-[#D4A017]/10 border border-[#D4A017]/30 flex items-center justify-center text-[#D4A017] group-hover:bg-[#D4A017]/20 transition-colors">
                ...
                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">04 / GRADES</span>
              </div>
            ...
            {/* Embedded Component Placeholder */}
            <div className="relative p-4 rounded-xl border border-white/[0.04] bg-[#080b15]/60 min-h-[90px] flex items-center justify-center">
              <span className="text-[10px] text-zinc-400 tracking-widest uppercase font-semibold text-center">Evaluation Panel Area</span>
            </div>
          ...
          <motion.div
            ...
            className="md:col-span-2 rounded-[24px] border border-white/[0.08] bg-[#111638]/40 backdrop-blur-md p-8 flex flex-col justify-between hover:border-[#D4A017]/40 hover:scale-[1.02] hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300 group overflow-hidden relative"
          >
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="w-10 h-10 rounded-xl bg-[#D4A017]/10 border border-[#D4A017]/30 flex items-center justify-center text-[#D4A017] group-hover:bg-[#D4A017]/20 transition-colors">
                ...
                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">05 / ANALYTICS</span>
              </div>
            ...
            {/* Embedded Component Placeholder */}
            <div className="relative mt-2 p-4 rounded-xl border border-white/[0.04] bg-[#080b15]/60 overflow-hidden flex flex-col gap-3 min-h-[110px] justify-center">
              {/* UI Component will be embedded here */}
              <div className="absolute inset-0 flex items-center justify-center bg-[#D4A017]/[0.01]">
                <span className="text-[10px] text-zinc-400 tracking-widest uppercase font-semibold">Charts & Export Panel Area</span>
              </div>
            </div>
