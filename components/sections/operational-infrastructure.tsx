      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          <motion.h2 
            ...
            className="text-[36px] md:text-[44px] font-bold text-white max-w-[900px] mx-auto leading-[1.08] tracking-tighter mb-8"
          >
          ...
          <motion.p
            ...
            className="text-[16px] leading-relaxed text-white/40 max-w-[700px] mx-auto font-medium"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-5 items-start">
           {capabilities.map((cap, i) => (
             <motion.div
               ...
               whileHover={{ y: -6 }}
               className={cn(
                 "group relative p-6 rounded-[24px] bg-white/[0.01] border border-white/5 backdrop-blur-xl transition-all duration-700 hover:bg-white/[0.03] hover:border-brand-gold/30 hover:shadow-[0_30px_60px_rgba(0,0,0,0.5)] min-h-[260px] flex flex-col",
                 cap.offset
               )}
             >
                ...
                <h3 className="text-[16px] font-bold text-white mb-3 tracking-tight group-hover:text-brand-gold transition-colors duration-500 leading-tight">{cap.title}</h3>
                
                <p className="text-[12px] leading-relaxed text-white/30 group-hover:text-white/50 transition-colors duration-700 mb-6">
                  {cap.desc}
                </p>
                ...
                <div className="absolute inset-0 rounded-[24px] bg-gradient-to-br from-brand-gold/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
             </motion.div>
           ))}
        </div>
      </div>
