...
export function ScaleStructure() {
  return (
    <section className="bg-[#050816] relative overflow-hidden">
      ...
      <div className="h-[100px] bg-[rgba(8,10,18,0.92)] border-y border-white/5 flex items-center">
            ...
            <div className="flex justify-between items-center">
               {[
                 ...
                 <div key={i} className="text-center">
                    <div className="text-[36px] font-bold text-white tracking-tighter leading-none mb-1">{m.val}</div>
      ...
      <div className="section-gap container-custom">
        <div className="grid lg:grid-cols-2 gap-[60px] items-center">
            ...
            <div className="space-y-4">
               {[
                 ...
                 <div key={i} className="p-5 rounded-xl bg-white/[0.02] border border-white/5 flex items-start gap-4">
                    <Shield className="w-4.5 h-4.5 text-brand-gold/60 mt-1" />
                    <div>
                       <h4 className="text-[15px] font-bold text-white mb-1">{item.t}</h4>
          ...
          <div className="flex justify-center lg:justify-end">
             <div className="relative w-full max-w-[520px] h-[380px] rounded-[22px] overflow-hidden border border-white/10 shadow-2xl bg-[#0A0C12] p-7 flex flex-col justify-between">
                <div className="flex justify-between items-center">
