...
export function InstitutionalCommandCenter() {
  return (
    <section className="bg-[#040816] relative py-24 overflow-hidden min-h-[960px] flex items-center selection:bg-[#f5b82e] selection:text-black">
      ...
      <div className="max-w-[1600px] mx-auto px-12 relative z-10 w-full scale-[0.98]">
        <div className="grid grid-cols-1 lg:grid-cols-[28%_44%_28%] gap-12 items-stretch">
          ...
          <div className="flex flex-col h-full py-6">
            <div className="mb-14">
              <div className="flex items-center gap-3 mb-8">
                ...
                />
                <span className="text-[11px] font-black text-[#f5b82e] uppercase tracking-[0.6em] opacity-80">
                  LIVE OPERATION COMMAND
                </span>
              </div>
              <h1 className="text-[68px] font-bold text-white leading-[0.9] tracking-[-0.07em] mb-12">
              ...
              <p className="text-[17px] text-white/40 leading-relaxed font-medium max-w-[360px] tracking-tight">
            ...
            <div className="space-y-8 mb-14">
              {features.map((feature, i) => (
                <div key={i} className="flex items-start gap-6 group cursor-default">
                  <div className="w-12 h-12 rounded-2xl bg-white/[0.02] border border-white/10 flex items-center justify-center shrink-0 group-hover:border-[#f5b82e]/40 group-hover:bg-[#f5b82e]/5 transition-all duration-500 shadow-xl">
                    <feature.icon className="w-5.5 h-5.5 text-[#f5b82e] opacity-80 group-hover:opacity-100 transition-opacity" />
                  </div>
                  <div className="pt-1">
                    <h3 className="text-[15px] font-bold text-white mb-1.5 tracking-tight group-hover:text-[#f5b82e] transition-colors">{feature.title}</h3>
                    <p className="text-[13px] text-white/30 leading-snug font-medium">{feature.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center gap-6 mb-16">
               <button className="h-15 px-10 rounded-2xl bg-gradient-to-br from-[#f5b82e] via-[#f5b82e] to-[#d49a20] text-black font-black text-[12px] uppercase tracking-[0.2em] hover:brightness-110 transition-all shadow-[0_25px_60px_rgba(245,184,46,0.2),inset_0_2px_4px_rgba(255,255,255,0.4)] active:scale-[0.98] flex items-center gap-3">
                  EXPLORE LIVE COMMAND
                  <ArrowRight className="w-4 h-4" />
               </button>
               <button className="h-15 px-10 rounded-2xl bg-white/[0.02] border border-white/10 text-white/60 font-black text-[12px] uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-white/[0.06] hover:text-white transition-all group">
                  <Play className="w-3.5 h-3.5 fill-white/20 group-hover:fill-white" />
                  PREVIEW INFRA
               </button>
            </div>
          ...
          <div className="flex flex-col gap-8 relative">
            ...
            <div className="grid grid-cols-4 gap-5 px-1">
               {topMetrics.map((m, i) => (
                 <div key={i} className="p-4 rounded-[20px] bg-gradient-to-b from-white/[0.04] to-transparent backdrop-blur-2xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative group hover:border-[#f5b82e]/20 transition-all duration-500">
                    <div className="flex items-center justify-between mb-2">
                       <span className="text-[8px] font-black text-white/30 uppercase tracking-widest">{m.label}</span>
                       <span className="text-[8px] font-black text-[#f5b82e] opacity-60">{m.status}</span>
                    </div>
                    <div className="text-[16px] font-bold text-white tracking-tight mb-2">{m.val}</div>
            ...
            <div className="flex-1 relative rounded-[48px] bg-[#0A0E18]/80 backdrop-blur-3xl border border-white/10 shadow-[0_120px_200px_rgba(0,0,0,0.9),inset_0_0_80px_rgba(245,184,46,0.02)] overflow-hidden group">
               ...
               <div className="absolute inset-0 p-10 flex flex-col justify-between">
                  ...
                  <div className="flex items-center justify-between gap-10 mt-auto relative z-10">
                     <div className="flex-1 h-14 rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10 p-4 flex items-center justify-between shadow-2xl group/waveform">
                        <div className="flex items-center gap-3 shrink-0">
                           <div className="w-2 h-2 rounded-full bg-[#f5b82e] shadow-[0_0_10px_#f5b82e]" />
                           <span className="text-[9px] font-black text-white/40 uppercase tracking-[0.3em]">Operational Waveform</span>
                        </div>
                        <div className="flex-1 flex items-end gap-1.5 px-8 h-full">
                        ...
                        <span className="text-[10px] font-mono text-[#f5b82e]/40 shrink-0">94.8% SYNC</span>
                     </div>
                     <div className="w-36 h-14 rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10 p-4 flex items-center justify-center shadow-2xl group/radar cursor-pointer hover:border-[#f5b82e]/40 transition-colors">
                        <Radio className="w-5 h-5 text-[#f5b82e] animate-pulse" />
                        <span className="ml-3 text-[9px] font-black text-white/30 uppercase tracking-widest">MAP_SCAN</span>
                     </div>
                  </div>
               </div>
          ...
          <div className="flex flex-col h-full py-6 gap-6">
             ...
             <div className="p-6 rounded-[32px] bg-gradient-to-b from-white/[0.04] to-transparent backdrop-blur-2xl border border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.5)] space-y-5 relative group overflow-hidden">
                <div className="absolute top-0 right-0 p-6 opacity-[0.03] group-hover:opacity-10 transition-opacity">
                   <Target className="w-24 h-24 text-[#f5b82e]" />
                </div>
                <div className="flex items-center justify-between relative z-10">
                   <div className="flex flex-col">
                      <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] mb-1">AI_CONFIDENCE_SCORE</span>
                      <span className="text-[36px] font-bold text-white tracking-tighter leading-none">94.8<span className="text-[20px] text-[#f5b82e]/60">%</span></span>
                   </div>
                ...
                <div className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-emerald-500/5 border border-emerald-500/10">
                   ...
                   <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Elite Validation Environment</span>
                </div>
             </div>

             {/* AI Facilitator Assistant: Active Refinement */}
             <div className="p-6 rounded-[32px] bg-gradient-to-b from-white/[0.04] to-transparent backdrop-blur-2xl border border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.5)] space-y-6 group">
                <div className="flex items-center gap-4">
                   <div className="w-10 h-10 rounded-xl bg-[#f5b82e]/10 border border-[#f5b82e]/20 flex items-center justify-center">
                ...
                <div className="p-5 rounded-2xl bg-[#f5b82e]/[0.03] border border-[#f5b82e]/10 space-y-4 shadow-inner">
                   <div className="text-[13px] text-white/70 leading-relaxed font-medium italic">
             ...
             <div className="p-6 rounded-[32px] bg-gradient-to-b from-white/[0.04] to-transparent backdrop-blur-2xl border border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.5)] space-y-5">
                <div className="flex items-center justify-between">
                   <span className="text-[12px] font-black text-white/60 uppercase tracking-[0.4em]">Live Timeline</span>
                ...
                <div className="h-14 flex items-center gap-2.5">
                   <TimelineSegment color="#3b82f6" width="35%" label="STRATEGY" active />
             ...
             <div className="mt-auto p-6 rounded-[28px] bg-white/[0.02] border border-white/5 space-y-4">
                <div className="flex items-center gap-3 mb-2">
                   <Shield className="w-4 h-4 text-white/30" />
                   <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">Governance & Security</span>
                </div>
        ...
        <div className="mt-20 h-18 rounded-[32px] bg-gradient-to-r from-white/[0.03] via-white/[0.05] to-white/[0.03] border border-white/10 px-12 flex items-center justify-between backdrop-blur-2xl shadow-2xl relative group overflow-hidden">
...
function StripItem({ icon: Icon, title, desc }: { icon: any, title: string, desc: string }) {
  return (
    <div className="flex items-center gap-4 group cursor-pointer py-2">
       <div className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center group-hover:border-[#f5b82e]/40 group-hover:bg-[#f5b82e]/10 transition-all duration-500">
          <Icon className="w-5 h-5 text-[#f5b82e] opacity-70 group-hover:opacity-100 transition-opacity" />
       </div>
       <div className="flex flex-col">
          <h4 className="text-[12px] font-bold text-white tracking-tight group-hover:text-[#f5b82e] transition-colors">{title}</h4>
          <p className="text-[10px] text-white/20 font-black uppercase tracking-widest leading-none mt-1 group-hover:text-white/40 transition-colors">{desc}</p>
       </div>
    </div>
  );
}
