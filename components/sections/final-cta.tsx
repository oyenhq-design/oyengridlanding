...
export function FinalCTA() {
  ...
  return (
    <section className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] py-20 md:py-28 border-t border-b border-white/5 overflow-hidden bg-[#071426]">
      ...
      <div className="max-w-[1150px] mx-auto px-6 relative z-30 flex flex-col gap-3">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col items-start pt-1">
            {/* Pill Badge */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-[#D4A017]/30 bg-black/40 mb-2">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-[1.1] mb-2.5">
              Frequently<br />
              Asked <span className="text-[#D4A017] italic font-serif font-normal">Questions</span>
            </h2>
            ...
            <Link
              href="#demo"
              className="inline-flex h-[36px] px-4.5 rounded-lg text-[10px] font-bold border border-[#D4A017]/40 hover:border-[#D4A017] bg-[#D4A017]/5 hover:bg-[#D4A017]/10 text-[#D4A017] tracking-wider uppercase transition-all duration-300 items-center justify-center gap-1.5 group cursor-pointer"
            >
              Contact Support
          ...
          <div className="lg:col-span-7 space-y-1.5">
            {faqItems.map((item, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className="rounded-[10px] border border-white/5 bg-black/60 backdrop-blur-md hover:border-[#D4A017]/15 transition-all duration-300 overflow-hidden shadow-sm"
                >
                  <button
                  ...
                  >
                    ...
                    <div className="w-5 h-5 rounded-full border border-[#D4A017]/30 flex items-center justify-center text-[#D4A017] bg-[#D4A017]/5 group-hover:border-[#D4A017]/60 transition-colors relative flex-shrink-0">
                      <span className={`absolute w-2 h-0.5 bg-[#D4A017] transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`} />
                      <span className={`absolute h-2 w-0.5 bg-[#D4A017] transition-transform duration-300 ${isOpen ? "rotate-90 scale-y-0" : ""}`} />
                    </div>
                    
                    <span className="text-[13px] font-bold text-white group-hover:text-[#D4A017] transition-colors">
                      {item.q}
                    </span>
                  </button>
        ...
        <div className="mt-3.5 flex items-center justify-between gap-6 px-5 py-2.5 rounded-[14px] bg-black/60 border border-white/5 backdrop-blur-xl max-w-4xl mx-auto shadow-lg w-full">
          <div className="flex items-center gap-4">
            {/* Headphone Icon Box */}
            <div className="w-9 h-9 rounded-lg border border-[#D4A017]/25 bg-[#D4A017]/5 flex items-center justify-center text-[#D4A017] flex-shrink-0">
          ...
          <Link
            href="#demo"
            className="inline-flex h-[32px] px-3.5 rounded-lg text-[10px] font-bold border border-[#D4A017]/30 hover:border-[#D4A017] bg-black hover:bg-[#D4A017]/10 text-white hover:text-[#D4A017] transition-all duration-300 items-center gap-1.5 cursor-pointer uppercase tracking-wider"
          >
            Contact Us
