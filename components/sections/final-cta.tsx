    ...
    <section className="relative py-64 md:py-80 bg-[#050816] overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-[1440px] mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-white mb-10 text-[56px] md:text-[104px] leading-[0.88] tracking-[-0.055em] font-bold">
          ...
          <p className="text-[19px] md:text-[23px] text-white/40 mb-16 max-w-3xl mx-auto leading-relaxed font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-10 mb-28">
            <button className="group h-20 px-16 rounded-2xl bg-brand-gold text-black font-black text-[17px] uppercase tracking-wider flex items-center gap-4 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_25px_60px_rgba(245,185,66,0.25)]">
              Deploy Institutional Grid
              <ArrowUpRight className="w-6 h-6 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
            </button>
            <button className="h-20 px-16 rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-xl text-white font-bold text-[17px] hover:bg-white/[0.05] transition-all flex items-center gap-4">
