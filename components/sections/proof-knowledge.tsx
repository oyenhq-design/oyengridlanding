      ...
      <section className="py-32 relative overflow-hidden">
        <div className="container-custom max-w-[1400px] relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-24 gap-12">
             ...
             >
               <div className="glow-ambient w-[300px] h-[300px] top-[-50px] left-[-50px]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              ...
              >
                <div className="relative aspect-[21/9] rounded-[40px] overflow-hidden mb-8 shadow-[0_40px_80px_rgba(0,0,0,0.5)] transition-all duration-1000 border-none group-hover:shadow-[0_60px_100px_rgba(0,0,0,0.7)]">
                  <img 
                    src={card.img} 
                    alt={card.title} 
