      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-3 gap-8 items-stretch">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative p-8 rounded-[28px] bg-[#080B14]/60 border border-white/5 backdrop-blur-[40px] transition-all duration-700 hover:border-brand-gold/40 flex flex-col min-h-[420px] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.6)]"
          >
            {/* Command Header */}
            <div className="flex justify-between items-start mb-6 relative z-30">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[15px] font-black uppercase tracking-[0.2em] text-white/90">Live Operations Analytics</h3>
                </div>
                <p className="text-[12px] text-white/30 font-bold uppercase tracking-widest">Real-time institutional performance intelligence</p>
              </div>
               ...
               <div className="mt-12 grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="space-y-1">
                       <div className="text-[26px] font-bold text-white tracking-tighter flex items-baseline gap-1.5">
                          {stat.v} <span className="text-[10px] text-brand-gold/40">{stat.unit}</span>
                       </div>
          ...
          <motion.div
            ...
            className="group relative p-8 rounded-[28px] bg-[#080B14]/60 border border-white/5 backdrop-blur-[40px] transition-all duration-700 hover:border-emerald-500/40 flex flex-col min-h-[420px] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.6)]"
          >
            {/* Command Header */}
            <div className="flex justify-between items-start mb-6 relative z-30">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[15px] font-black uppercase tracking-[0.2em] text-white/90">Governance Matrix</h3>
                </div>
                <p className="text-[12px] text-white/30 font-bold uppercase tracking-widest">Security, compliance and institutional control systems</p>
              </div>
