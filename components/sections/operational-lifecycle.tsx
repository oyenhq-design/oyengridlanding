  ...
  return (
    <section className="pb-24 md:pb-32 pt-12 md:pt-16 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="mb-16">
          <span className="eyebrow !text-black !font-black !tracking-widest">OPERATIONAL LIFECYCLE</span>
          <h2 className="max-w-[720px] mt-4 mb-4 !text-black font-black">
            Everything you need to run successful learning programs.
          </h2>
          <p className="text-editorial max-w-[640px] !text-black !font-bold">
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
          ...
          <div className="space-y-12">
             <AnimatePresence mode="wait">
                ...
                >
                   <div>
                      <h3 className="text-[34px] font-black !text-black mb-6 leading-[1.1] tracking-tighter">{stages[activeIdx].title}</h3>
                      <p className="text-[16px] leading-relaxed !text-black !font-bold mb-10 max-w-[380px]">
