...
export function FooterPremium() {
  ...
  return (
    <footer className="bg-[#050816] pt-[110px] pb-[64px] border-t border-white/5 relative overflow-hidden">
      <div className="container-custom relative z-10">
        
        {/* BRAND & MISSION */}
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-24 pb-24 border-b border-white/5">
           ...
           <p className="text-[17px] text-white/30 max-w-2xl leading-relaxed font-medium">
        ...
        {/* BOTTOM TELEMETRY */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-[12px] font-black uppercase tracking-[0.3em] text-white/20">
