          ...
          <div className="relative flex flex-col items-end">
            ...
            {isOpen && !isMinimized && (
              <motion.div
                ...
                className="w-[380px] h-[620px] bg-[#0E1728]/95 backdrop-blur-[40px] border border-white/10 rounded-[28px] shadow-[0_80px_160px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden mb-6"
              >
                {/* Gold Top Border Accent */}
                <div className="h-1 w-full bg-[#d6a63c] opacity-40" />

                {/* Header */}
                <div className="p-6 bg-white/[0.02] border-b border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="relative w-12 h-12 rounded-full overflow-hidden border border-white/10 bg-[#030712]">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-[#d6a63c] font-black uppercase tracking-[0.2em] mt-1 flex items-center gap-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {quickActions.map((action, i) => (
                      <button 
                        ...
                        className="px-3 py-1.5 rounded-full bg-white/[0.03] border border-white/5 text-[11px] text-white/40 hover:text-[#d6a63c] hover:border-[#d6a63c]/30 hover:bg-[#d6a63c]/5 transition-all flex items-center gap-2"
                      >
                ...
                <div className="p-6 pt-0">
                  <div className="relative group">
                    <input 
                      ...
                      className="w-full bg-[#030712]/60 border border-white/10 rounded-2xl py-4 pl-5 pr-24 text-[14px] text-white placeholder:text-white/20 focus:outline-none focus:border-[#d6a63c]/40 transition-all"
                    />
                    <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                      <button className="p-2 text-white/20 hover:text-white transition-colors">
                        <Paperclip className="w-4 h-4" />
                      </button>
                      <button onClick={() => handleSendMessage(input)} className="w-10 h-10 rounded-xl bg-[#d6a63c] text-[#030712] flex items-center justify-center hover:scale-105 transition-all">
            ...
            <motion.button
              ...
              animate={{ 
                ...
                boxShadow: ["0 0 0 0 rgba(214, 166, 60, 0)", "0 0 0 10px rgba(214, 166, 60, 0.05)", "0 0 0 0 rgba(214, 166, 60, 0)"]
              }}
              transition={{
                boxShadow: { duration: 8, repeat: Infinity, ease: "easeInOut" }
              }}
              className="relative group w-[58px] h-[58px] rounded-full bg-[#0E1728]/80 backdrop-blur-xl border border-white/10 flex items-center justify-center shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
            >
              <div className="relative w-[50px] h-[50px] rounded-full overflow-hidden border border-[#d6a63c]/20 group-hover:border-[#d6a63c] transition-colors duration-500">
              ...
              <div className="absolute bottom-0 right-0 w-3.5 h-3.5 bg-emerald-500 border-2 border-[#030712] rounded-full" />
              <div className="absolute -inset-[2px] rounded-full border border-[#d6a63c] opacity-0 group-hover:opacity-20 transition-opacity duration-500" />
            </motion.button>
          </div>
        )}
      </AnimatePresence>
