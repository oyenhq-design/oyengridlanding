...
export function Header() {
  ...
  return (
    <header className={cn(
      ...
      <div className="max-w-[1440px] mx-auto h-full flex items-center justify-between px-8 relative z-10">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <button className="h-[44px] px-6 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white text-[14px] font-bold transition-all hover:bg-white/[0.08] hover:border-brand-gold/30 hover:text-brand-gold">
              Contact Sales
            </button>
...
export function AnnouncementBar() {
  ...
  return (
    <div className="pt-[100px] px-4 md:px-10 flex justify-center relative z-[60]">
      <motion.div 
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 1, y: 0 }}
        className="h-[56px] bg-[#0E1424] border border-white/[0.06] rounded-[14px] px-6 flex items-center justify-between w-full max-w-[1440px] shadow-2xl"
      >
