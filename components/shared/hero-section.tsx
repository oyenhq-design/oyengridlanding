...
import { Search, Bell, Home, Users, Calendar, Layers, Database, ChevronDown, CheckCircle2, PlayCircle } from "lucide-react"
import { motion } from "framer-motion"

export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[#0A0A0B] pt-32 pb-24 border-b border-[#1F1F23]">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-[72px] font-bold text-white mb-8 leading-[1.1] tracking-tight">
              Run and manage your programmes from a <span className="text-[#C9A96E]">single, structured system.</span>
            </h1>
            
            <p className="text-lg text-[#A1A1AA] mb-12 leading-relaxed max-w-sm font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/get-started">
                <Button className="bg-[#C9A96E] hover:bg-[#B39358] text-[#0A0A0B] h-12 px-8 text-sm font-bold rounded-sm shadow-none transition-all w-full sm:w-auto">
                  Get Started
                </Button>
              </Link>
              <Link href="#pricing">
                <Button variant="outline" className="border-white text-white bg-transparent hover:bg-white hover:text-black h-12 px-8 text-sm font-semibold rounded-sm shadow-none transition-all w-full sm:w-auto">
                  Book a Demo
                </Button>
              </Link>
            </div>
          ...
          <motion.div 
            ...
            className="relative h-[600px] bg-[#0A0A0B] border border-[#1F1F23] flex overflow-hidden rounded-sm"
          >
            {/* Sidebar */}
            <div className="w-56 border-r border-[#1F1F23] bg-[#0A0A0B] flex flex-col z-10 hidden sm:flex">
              <div className="h-14 border-b border-[#1F1F23] flex items-center px-4">
                <div className="w-5 h-5 bg-[#C9A96E] rounded-sm flex items-center justify-center mr-3">
                  <div className="w-1.5 h-1.5 bg-[#0A0A0B] rounded-full" />
                </div>
            ...
            <div className="flex-1 bg-[#111113] flex flex-col overflow-hidden">
              {/* Topbar */}
              <div className="h-14 border-b border-[#1F1F23] bg-[#0A0A0B] flex items-center justify-between px-6 z-20">
              ...
              <div className="flex-1 p-6 overflow-hidden">
                <div className="flex justify-between items-end mb-6">
                  ...
                  <div className="bg-[#0A0A0B] border border-[#1F1F23] px-2 py-1 flex items-center gap-2 text-[10px] text-white uppercase tracking-wider rounded-sm">
                    <span>This Week</span>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-[#0A0A0B] border border-[#1F1F23] p-4 rounded-sm">
                ...
                {/* Activity Feed */}
                <div className="bg-[#0A0A0B] border border-[#1F1F23] rounded-sm overflow-hidden mb-6">
              ...
              <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-[#111113] to-transparent pointer-events-none" />
            </div>
          </motion.div>
        </div>
      </div>
