  ...
  return (
    <section className="relative w-full h-[500px] lg:h-[600px] overflow-hidden group">
      ...
      <div className="relative z-10 h-full max-w-[1280px] mx-auto px-10 lg:px-14 flex flex-col justify-center items-start text-left">
        ...
        {/* Soft Content Glow */}
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#D4AF37] opacity-[0.06] blur-[140px] rounded-full pointer-events-none" />
        ...
        >
          <div className="inline-flex items-center gap-3 text-[#D4AF37] text-[13px] font-bold tracking-[0.3em] uppercase mb-8">
          ...
          <h2 className="text-[44px] md:text-[64px] font-bold text-white leading-[1.05] tracking-tight mb-10">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FACC15] via-white to-[#EAB308]">with absolute confidence.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <Link 
              href="/get-started"
              className="relative px-12 py-5 rounded-2xl text-[17px] font-bold transition-all duration-300 overflow-hidden group/btn shadow-[0_20px_50px_rgba(212,175,55,0.3)] hover:shadow-[0_30px_70px_rgba(212,175,55,0.5)] hover:scale-105 active:scale-95"
            >
