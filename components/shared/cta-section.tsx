        ...
        <div className="bg-[#111113] border border-[#1F1F23] rounded-sm p-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 shrink-0">
            <Link href="/get-started">
              <Button className="w-full sm:w-auto bg-[#C9A96E] hover:bg-[#B39358] text-[#0A0A0A] h-12 px-8 text-sm font-semibold rounded-sm shadow-none">
                Start Free Trial
              </Button>
            </Link>
            <Link href="/pricing">
              <Button 
                variant="outline" 
                className="w-full sm:w-auto h-12 px-8 text-sm font-semibold rounded-sm bg-transparent border border-[#1F1F23] text-white hover:border-[#C9A96E] hover:bg-transparent transition-all shadow-none"
              >
                View Pricing
              </Button>
            </Link>
