    ...
    <>
      ...
      <main className="min-h-screen bg-[#070913] text-white selection:bg-[#FFC72C] selection:text-black antialiased pt-28 pb-24">
        <div className="max-w-[800px] mx-auto px-6">
          ...
          {/* Back link */}
          <Link href="/resources/case-studies" className="inline-flex items-center gap-2 text-sm text-white/50 hover:text-white mb-8 transition-colors">
          ...
          <article className="prose prose-invert max-w-none text-white/75 space-y-6 leading-relaxed text-sm md:text-base font-light mb-16">
            ...
            <p>
              Managing separate cohorts across 3 countries required distinct facilitator mapping, calendar coordination, and grading schemas. Roster discrepancies and manually updating progression records created bottlenecks.
            </p>
            ...
            <blockquote className="border-l-2 border-[#FFC72C] pl-4 italic text-white/90 my-6">
              "We scaled our operations to over 5,000 active learners across 3 countries without adding a single administrative hire."
            </blockquote>
          </article>
          ...
          <div className="border-t border-white/10 pt-10 mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: "AltSchool saves 4 hours weekly per cohort", href: "/resources/case-studies/altschool-saves-4-hours-weekly" },
