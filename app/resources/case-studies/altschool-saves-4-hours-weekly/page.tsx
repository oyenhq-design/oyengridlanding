        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <header className="mb-10">
            ...
            <h1 className="text-3xl md:text-5xl font-black tracking-tight leading-[1.1] mb-6">
              AltSchool saves 4 hours weekly managing training operations
            </h1>
          ...
          <div className="border-t border-white/10 pt-10 mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: "How TalentQL scaled training across 3 countries", href: "/resources/case-studies/talentql-scales-training" },
                { title: "AI Summaries feature live", href: "/resources/product-updates/ai-summaries-feature-live" }
              ].map((rel, idx) => (
