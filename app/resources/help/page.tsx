...
import { 
  Play, Shield, BookOpen, Users, Sparkles, HelpCircle
} from "lucide-react";
        ...
        <section className="relative pt-32 pb-24 md:pt-40 md:pb-36 overflow-hidden">
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            <div className="max-w-[840px]">
              ...
              >
                Find answers, troubleshoot issues, and learn how to use every part of OYEN GRID with step-by-step guides and FAQs.
              </motion.p>
        ...
        <section className="py-24 bg-[#090C16] border-t border-white/5 relative">
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { title: "Getting Started", desc: "Setting up your first cohort workspace and invite rules.", icon: Play, color: "text-[#FFC72C]" },
                { title: "Account & Billing", desc: "Configure license allocations, checkout payment setups, and invoices.", icon: Shield, color: "text-blue-400" },
                { title: "Training Programs", desc: "Setting up virtual webinars and adding curriculum outlines.", icon: BookOpen, color: "text-purple-400" },
                { title: "Learner Management", desc: "Handling registration verification and participant data exports.", icon: Users, color: "text-emerald-400" },
                { title: "AI Features", desc: "Enabling OYEN AI summary generation and Slack log prompts.", icon: Sparkles, color: "text-[#FFC72C]" },
                { title: "Contact Support", desc: "Reach out to support coordinators or sales engineers.", icon: HelpCircle, color: "text-indigo-400" }
              ].map((card, i) => (
