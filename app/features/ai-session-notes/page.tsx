...
import { 
  FileText, Sparkles, CheckSquare, Search, Download, 
  Play, CheckCircle2, Clock, Users, ArrowRight
} from "lucide-react";

export default function AISessionNotesPage() {
  return (
    <>
      <Header />
      <AnnouncementBar />
        ...
        <section className="relative pt-32 pb-24 md:pt-40 md:pb-36 overflow-hidden">
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            <div className="max-w-[840px]">
              ...
              >
                Automatically generate structured notes for every meeting, training session, webinar, or workshop. Capture discussions, decisions, action items, and key takeaways without manual note-taking.
              </motion.p>
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            ...
            <div className="mb-16">
              ...
              <p className="text-white/60 max-w-[640px] text-sm md:text-base leading-relaxed">
                Transform voice data into structured workflow documents with high precision.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Automatic Note Generation", desc: "Transcribe live sessions and layout structured outlines.", icon: FileText, color: "text-[#FFC72C]" },
                { title: "Action Items & Follow-ups", desc: "Instantly delegate tasks to individuals from session transcripts.", icon: CheckSquare, color: "text-purple-400" },
                { title: "Searchable Session History", desc: "Search notes globally across all programs.", icon: Search, color: "text-blue-400" },
                { title: "Export & Share", desc: "Export to email, PDFs, or integrate directly with Slack.", icon: Download, color: "text-emerald-400" }
              ].map((card, i) => (
        ...
        <section className="py-24 bg-[#070913] border-t border-white/5">
          <div className="max-w-[800px] mx-auto px-8 text-center flex flex-col items-center gap-6">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
              Discover how OYEN AI helps your organization automate routine work, improve decision-making, and keep every program running smoothly.
            </h2>
