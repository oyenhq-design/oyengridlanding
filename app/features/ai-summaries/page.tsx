...
import { 
  Brain, Sparkles, BarChart3, LineChart, Activity,
  Play, CheckCircle2
} from "lucide-react";
    ...
    <>
      ...
      <main className="min-h-screen bg-[#070913] text-white selection:bg-[#FFC72C] selection:text-black antialiased overflow-x-hidden">
        ...
        <section className="relative pt-32 pb-24 md:pt-40 md:pb-36 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-[#FFC72C]/5 rounded-full blur-[150px] pointer-events-none" />
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            <div className="max-w-[840px]">
              ...
              >
                Instantly summarize training programs, learner progress, reports, meetings, and operational activities into concise, easy-to-read insights.
              </motion.p>
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            ...
            <div className="mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight mb-4">
                Automated Program Summaries
              </h2>
              <p className="text-white/60 max-w-[640px] text-sm md:text-base leading-relaxed">
                Condense multiple operational databases into plain language text logs automatically.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Program Summaries", desc: "Synthesize session details across entire cohorts.", icon: Brain, color: "text-[#FFC72C]" },
                { title: "Learner Progress Insights", desc: "Instantly draft performance notes for individual learners.", icon: Sparkles, color: "text-purple-400" },
                { title: "Executive Reports", desc: "Summarize outcomes to share with leadership.", icon: LineChart, color: "text-blue-400" },
                { title: "Performance Highlights", desc: "Surface major milestones and engagement achievements.", icon: Activity, color: "text-emerald-400" }
              ].map((card, i) => (
