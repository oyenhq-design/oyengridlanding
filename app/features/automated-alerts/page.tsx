...
import { 
  Bell, Clock, AlertTriangle, ShieldCheck, Sparkles,
  Play, CheckCircle2
} from "lucide-react";
    ...
    <>
      ...
      <main className="min-h-screen bg-[#070913] text-white selection:bg-[#FFC72C] selection:text-black antialiased overflow-x-hidden">
        ...
        <section className="relative pt-32 pb-24 md:pt-40 md:pb-36 overflow-hidden">
          {/* Ambient Glows */}
          <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-red-500/10 rounded-full blur-[120px] pointer-events-none" />
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            <div className="max-w-[840px]">
              ...
              >
                Receive intelligent notifications about attendance, learner engagement, deadlines, compliance, and operational risks before they become problems.
              </motion.p>
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            ...
            <div className="mb-16">
              ...
              <p className="text-white/60 max-w-[640px] text-sm md:text-base leading-relaxed">
                Stay updated on cohort deviations and compliance flags in real time.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Attendance Alerts", desc: "Get notified of sudden cohort drop-off trends immediately.", icon: Bell, color: "text-[#FFC72C]" },
                { title: "Risk Detection", desc: "Flag learners showing signs of falling behind course paces.", icon: AlertTriangle, color: "text-red-400" },
                { title: "Deadline Reminders", desc: "Nudge students on missing program module requirements.", icon: Clock, color: "text-blue-400" },
                { title: "Compliance Notifications", desc: "Identify role access drift and certificate expiration states.", icon: ShieldCheck, color: "text-emerald-400" }
              ].map((card, i) => (
