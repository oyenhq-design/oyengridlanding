...
import { 
  Boxes, Calendar, Users, CheckSquare, Award, Sparkles, 
  BarChart3, ShieldAlert, ChevronRight, Play, ArrowRight, CheckCircle2,
  Clock, Shield, Settings, Mail
} from "lucide-react";
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#070913] text-white selection:bg-[#FFC72C] selection:text-black antialiased overflow-x-hidden">
        ...
        <section className="relative pt-32 pb-24 md:pt-40 md:pb-36 overflow-hidden">
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            <div className="max-w-[840px]">
              ...
              >
                Plan, coordinate, and deliver programs at{" "}
              ...
              >
                Manage cohorts, schedules, facilitators, attendance, assessments, reporting, collaboration, and AI workflows from one operational workspace.
              </motion.p>
        ...
        <section id="overview" className="py-24 bg-[#090C16] border-t border-white/5 relative">
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Program Planning", desc: "Design curriculum outlines, map facilitators, and create session templates.", icon: Calendar, color: "text-blue-400" },
                { title: "Cohort Management", desc: "Automate student registration, profile fields, and group allocations.", icon: Users, color: "text-purple-400" },
                { title: "Attendance Tracking", desc: "Get real-time verification and custom checks on participant presence.", icon: CheckSquare, color: "text-emerald-400" },
                { title: "Reporting & Analytics", desc: "Generate grade sheets, operational reports, and programmatic insights.", icon: BarChart3, color: "text-[#FFC72C]" }
              ].map((card, i) => (
        ...
        {/* ─── 3. DEEP FEATURES: DETAIL SECTIONS ─────────────────────────────── */}
        <section className="py-24 bg-[#070913]">
          <div className="max-w-[1280px] mx-auto px-8 space-y-32">
            ...
            {/* 3.3 AUTOMATED ASSESSMENTS & GRADING */}
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                <span className="text-[10px] font-black tracking-[0.25em] text-[#FFC72C] uppercase block mb-4">
                  03. ASSESSMENTS & CREDENTIALS
                </span>
                <h3 className="text-3xl font-extrabold text-white mb-6">
        ...
        {/* ─── 4. ENTERPRISE SEGMENT: INFRASTRUCTURE & SECURITY ───────────────── */}
        <section className="py-24 bg-[#090C16] border-t border-white/5">
          <div className="max-w-[1280px] mx-auto px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-3xl font-extrabold text-white mb-6">
                  Enterprise security at every level of delivery.
                </h3>
                <p className="text-white/60 text-sm md:text-base leading-relaxed mb-10">
                  From internal coordination to hosting thousands of participants, OYEN GRID runs on high-availability cloud infrastructure with isolated database containers and active monitoring.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Isolated Databases", desc: "Each organization's workspace runs on isolated storage schemas." },
                    { title: "Role Permissions", desc: "Granular access matrices for facilitators, admins, and reviewers." },
                    { title: "Audit Trail logs", desc: "Complete records of all system interactions and configuration edits." },
                    { title: "Compliance Ready", desc: "Built inside a SOC 2 compliant environment prioritizing data confidentiality." }
                  ].map((spec, i) => (
                    <div key={i} className="flex gap-3">
                      <Shield className="w-4.5 h-4.5 text-blue-400 shrink-0 mt-0.5" />
                      <div>
                        <h5 className="text-[13px] font-bold text-white">{spec.title}</h5>
                        <p className="text-[11.5px] text-white/45 leading-relaxed mt-0.5">{spec.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="w-full max-w-[480px] p-6 rounded-2xl bg-[#070913] border border-white/5 shadow-lg space-y-4">
                  <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                    <Settings className="w-4 h-4 text-white/40" />
                    <span className="text-xs font-bold text-white/80">Security Policy Control</span>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-xs">
                      <span className="text-white/60">Enforce Multi-Factor Authentication</span>
                      <span className="text-emerald-400 font-bold">ENABLED</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                      <span className="text-white/60">Session Timeout Threshold</span>
                      <span className="text-white/90">30 minutes</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                      <span className="text-white/60">Restricted IP Address Access</span>
                      <span className="text-[#FFC72C] font-bold">2 IP rules active</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-24 bg-[#070913] border-t border-white/5">
          <div className="max-w-[800px] mx-auto px-8 text-center flex flex-col items-center gap-6">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
              Ready to automate your program management?
            </h2>
            <p className="text-sm md:text-base text-white/60 max-w-xl leading-relaxed">
              Join leading training and operations teams who use OYEN GRID to scale cohorts, automate administrative tasks, and prove impact.
            </p>
