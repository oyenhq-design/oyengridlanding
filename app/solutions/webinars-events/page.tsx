...
import { 
  Video, Users, Calendar, BarChart3, Sparkles, 
  CheckCircle2, Play, Activity, Clock
} from "lucide-react";
        ...
        <section className="relative pt-32 pb-24 md:pt-40 md:pb-36 overflow-hidden">
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            <div className="max-w-[840px]">
              ...
              >
                Host live webinars, virtual events, workshops, and hybrid sessions with attendance and engagement tracking.
              </motion.p>
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            ...
            <div className="mb-16">
              ...
              <p className="text-white/60 max-w-[640px] text-sm md:text-base leading-relaxed">
                Coordinate virtual workshops, setup application pages, capture verified logs of presence, and compile AI summaries automatically.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Event Planning", desc: "Build scheduling templates, map speakers, and invite cohorts.", icon: Calendar, color: "text-blue-400" },
                { title: "Onboarding Pages", desc: "Embed customized signup pages to capture registrations and surveys.", icon: Users, color: "text-purple-400" },
                { title: "Attendance Tracking", desc: "Log active minutes and check-in times for all participants.", icon: Clock, color: "text-emerald-400" },
                { title: "AI Event Notes", desc: "Transcribe audio feeds and generate clean action summaries.", icon: Sparkles, color: "text-[#FFC72C]" }
              ].map((card, i) => (
        ...
        <section className="py-24 bg-[#070913] border-t border-white/5">
          <div className="max-w-[800px] mx-auto px-8 text-center flex flex-col items-center gap-6">
            ...
            <p className="text-sm md:text-base text-white/60 max-w-xl leading-relaxed">
              Plan live virtual classes, track registration counts, transcribe audio logs, and capture engagement insights.
            </p>
