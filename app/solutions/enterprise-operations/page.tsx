...
import { 
  Target, Users, Shield, Award, LineChart, 
  CheckCircle2, Play, Activity, Folder
} from "lucide-react";
    ...
    <>
      ...
      <main className="min-h-screen bg-[#070913] text-white selection:bg-[#FFC72C] selection:text-black antialiased overflow-x-hidden">
        ...
        <section className="relative pt-32 pb-24 md:pt-40 md:pb-36 overflow-hidden">
          ...
          <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-[#FFC72C]/5 rounded-full blur-[150px] pointer-events-none" />
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            <div className="max-w-[840px]">
              ...
              >
                Upskill employees, onboard teams, manage compliance training, certifications, and workforce development.
              </motion.p>
        ...
        {/* ─── 2. ENTERPRISE TRAINING OVERVIEW ──────────────────────────────── */}
          ...
          <div className="max-w-[1280px] mx-auto px-8 relative z-10">
            ...
            <div className="mb-16">
              ...
              <p className="text-white/60 max-w-[640px] text-sm md:text-base leading-relaxed">
                Streamline employee onboarding, verify regulatory compliance checks, manage learning pathways, and coordinate team reviews with ease.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Employee Onboarding", desc: "Automate setup tasks, compliance checklists, and initial training pathways.", icon: Users, color: "text-blue-400" },
                { title: "Compliance Logs", desc: "Enforce required regulatory tutorials and record audit metrics.", icon: Shield, color: "text-purple-400" },
                { title: "Certifications", desc: "Issue secure credential badges verified by corporate admin nodes.", icon: Award, color: "text-emerald-400" },
                { title: "Manager Dashboards", desc: "Get high-level visualization on employee completion rates and skill sets.", icon: LineChart, color: "text-[#FFC72C]" }
              ].map((card, i) => (
        ...
        <section className="py-24 bg-[#070913] border-t border-white/5">
          <div className="max-w-[800px] mx-auto px-8 text-center flex flex-col items-center gap-6">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
              Ready to automate employee development?
            </h2>
            <p className="text-sm md:text-base text-white/60 max-w-xl leading-relaxed">
              Track course milestone completion, verify legal compliance logs, and map organizational skill pathways.
            </p>
